package dev.reprator.haat.ui.components.indicator.internal
...
import dev.reprator.haat.ui.components.indicator.PagerIndicatorOrientation
    ...
    Canvas(
        ...
        translate(
            ...
            for (i in firstVisible..lastVisible) {
                ...
                val left = if (orientation == PagerIndicatorOrientation.Horizontal) mainAxisStart else crossAxisStart
                val top = if (orientation == PagerIndicatorOrientation.Horizontal) crossAxisStart else mainAxisStart
